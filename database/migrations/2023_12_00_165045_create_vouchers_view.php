...
CREATE OR REPLACE VIEW vouchers_view AS
        ...
        UNION
        SELECT vvp.*, vrv.full_name 'requested_fullname', IF(vrv.department like 'Coordi%' or vrv.department like '%Regi%', vrv.department, CONCAT('DIRECTOR DEL DEPARTAMENTO DE ',vrv.department)) 'workstation', vrv.img_firm, vrv.img_stamp,
