...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        ORDER BY av.date AND av.active=1 DESC LIMIT 1;

        CREATE OR REPLACE VIEW active_loan_view AS
        SELECT lv.id loa_folio,
        ...
        ORDER BY lv.created_at AND lv.active=1 DESC LIMIT 1;

        CREATE OR REPLACE VIEW vehicle_details_view AS
        ...
        LEFT JOIN active_loan_view alv ON aav.ass_folio=alv.ass_vehicle_id
        WHERE v.stock_number=1;
